...
From there a user can further sort his or hers list of choice based on ABV or number of ratings
the main menu allows a user to choose between a top 20 list of all the beers in the world
a top 20 list of a particular sub-style
or a top 20 list based on the two parent styles Ales or Lagers.
